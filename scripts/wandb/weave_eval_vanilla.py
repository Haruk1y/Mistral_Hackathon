...
BASE_MODEL_REPO = os.getenv(
    ...
    os.getenv("HF_BASE_MODEL_ID", "mistralai/Mistral-Large-3-675B-Instruct-2512"),
)
...
async def run():
    ...
    print("=== Evaluation Result: MODEL_C (HF local base model only) ===")
    print(
        json.dumps(
            {
