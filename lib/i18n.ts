...
const EN_MESSAGES = {
  ...
  composePartsPanelTitle: "Owned Parts",
  composePartsSlotPrefix: "Active Slot",
  composePartsHint: "Click a slot above, then choose one part from this list.",
  ...
  composeNoPartsInSlot: "No owned parts in this slot yet.",
